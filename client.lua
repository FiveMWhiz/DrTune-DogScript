...
Citizen.CreateThread(function()
    ...
    createMenu.OnItemSelect = function(sender, item, index)
        if item == spawnShepherd then
            TriggerEvent('oDogScript:spawnDog', 'a_c_shepherd')
        end
        
        if item == spawnHusky then
            TriggerEvent('oDogScript:spawnDog', 'a_c_husky')
        end

        if item == spawnRetriever then
            TriggerEvent('oDogScript:spawnDog', 'a_c_retriever')
        end

        if item == deleteDog then
            TriggerEvent('oDogScript:deleteDog')
        end
    end
    ...
    actionMenu.OnItemSelect = function(sender, item, index)
        if item == followDog then
            TriggerEvent('oDogScript:followDog')
        end

        if item == sitDog then
            TriggerEvent('oDogScript:sitDog')
        end

        if item == enterVehicle then
            TriggerEvent('oDogScript:enterVehicle')
        end

        if item == teleportDog then
            TriggerEvent('oDogScript:teleportDog')
        end

        if item == carryDog then
            TriggerEvent('oDogScript:carryDog')
        end

        if item == layDog then
            TriggerEvent('oDogScript:layDog')
        end

        if item == barkDog then
            TriggerEvent('oDogScript:barkDog')
        end

        if item == standDog then
            TriggerEvent('oDogScript:standDog')
        end

        if item == vehicleSearch then
            TriggerEvent('oDogScript:searchVehicle')
        end
    end
...
RegisterNetEvent("oDogScript:cannabisDetected")

AddEventHandler("oDogScript:cannabisDetected", function()
    if spawnedDog ~= nil then
...
RegisterNetEvent('oDogScript:deleteDog')

AddEventHandler('oDogScript:deleteDog', function()
    if spawnedDog ~= nil then
...
RegisterNetEvent("oDogScript:followDog")

AddEventHandler("oDogScript:followDog", function()
    if spawnedDog ~= nil then
...
RegisterNetEvent("oDogScript:searchVehicle")

AddEventHandler("oDogScript:searchVehicle", function()
...
RegisterNetEvent("oDogScript:enterVehicle")

AddEventHandler("oDogScript:enterVehicle", function()
    if spawnedDog ~= nil and not inVehicle then
        local Player = PlayerPedId()
...
RegisterNetEvent("oDogScript:sitDog")

AddEventHandler("oDogScript:sitDog", function()
    if spawnedDog ~= nil then
...
RegisterNetEvent("oDogScript:layDog")

AddEventHandler("oDogScript:layDog", function()
    if spawnedDog ~= nil then
...
RegisterNetEvent("oDogScript:barkDog")

AddEventHandler("oDogScript:barkDog", function()
    if spawnedDog ~= nil then
...
RegisterNetEvent("oDogScript:standDog")

AddEventHandler("oDogScript:standDog", function()
    if spawnedDog ~= nil then
        ClearPedTasks(spawnedDog)
    end
end)

RegisterNetEvent("oDogScript:carryDog")

AddEventHandler("oDogScript:carryDog", function()
    if spawnedDog ~= nil then
        if inVehicle then
            local vehicle = GetEntityAttachedTo(spawnedDog)
            local vehPos = GetEntityCoords(vehicle)
...
RegisterNetEvent("oDogScript:teleportDog")

AddEventHandler("oDogScript:teleportDog", function()
    if spawnedDog ~= nil then
        if inVehicle then
            local vehicle = GetEntityAttachedTo(spawnedDog)
            local vehPos = GetEntityCoords(vehicle)
...
RegisterNetEvent("oDogScript:spawnDog")

AddEventHandler("oDogScript:spawnDog", function(model)
    if spawnedDog == nil then
