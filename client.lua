...
Citizen.CreateThread(function()
    ...
    createMenu.OnItemSelect = function(sender, item, index)
        if item == spawnShepherd then
            TriggerEvent('DevlarWoof:spawnDog', 'a_c_shepherd')
        end
        
        if item == spawnHusky then
            TriggerEvent('DevlarWoof:spawnDog', 'a_c_husky')
        end

        if item == spawnRetriever then
            TriggerEvent('DevlarWoof:spawnDog', 'a_c_retriever')
        end

        if item == deleteDog then
            TriggerEvent('DevlarWoof:deleteDog')
        end
    end
    ...
    actionMenu.OnItemSelect = function(sender, item, index)
        if item == followDog then
            TriggerEvent('DevlarWoof:followDog')
        end

        if item == sitDog then
            TriggerEvent('DevlarWoof:sitDog')
        end

        if item == enterVehicle then
            TriggerEvent('DevlarWoof:enterVehicle')
        end

        if item == teleportDog then
            TriggerEvent('DevlarWoof:teleportDog')
        end

        if item == carryDog then
            TriggerEvent('DevlarWoof:carryDog')
        end

        if item == layDog then
            TriggerEvent('DevlarWoof:layDog')
        end

        if item == barkDog then
            TriggerEvent('DevlarWoof:barkDog')
        end

        if item == standDog then
            TriggerEvent('DevlarWoof:standDog')
        end

        if item == vehicleSearch then
            TriggerEvent('DevlarWoof:searchVehicle')
        end
    end
...
RegisterNetEvent("DevlarWoof:cannabisDetected")

AddEventHandler("DevlarWoof:cannabisDetected", function()
    if spawnedDog ~= nil then
...
RegisterNetEvent('DevlarWoof:deleteDog')

AddEventHandler('DevlarWoof:deleteDog', function()
    if spawnedDog ~= nil then
...
RegisterNetEvent("DevlarWoof:followDog")

AddEventHandler("DevlarWoof:followDog", function()
    if spawnedDog ~= nil then
...
RegisterNetEvent("DevlarWoof:searchVehicle")

AddEventHandler("DevlarWoof:searchVehicle", function()
...
RegisterNetEvent("DevlarWoof:enterVehicle")

AddEventHandler("DevlarWoof:enterVehicle", function()
    if spawnedDog ~= nil and not inVehicle then
        local Player = PlayerPedId()
...
RegisterNetEvent("DevlarWoof:sitDog")

AddEventHandler("DevlarWoof:sitDog", function()
    if spawnedDog ~= nil then
...
RegisterNetEvent("DevlarWoof:layDog")

AddEventHandler("DevlarWoof:layDog", function()
    if spawnedDog ~= nil then
...
RegisterNetEvent("DevlarWoof:barkDog")

AddEventHandler("DevlarWoof:barkDog", function()
    if spawnedDog ~= nil then
...
RegisterNetEvent("DevlarWoof:standDog")

AddEventHandler("oDogScDevlarWoofript:standDog", function()
    if spawnedDog ~= nil then
        ClearPedTasks(spawnedDog)
    end
end)

RegisterNetEvent("DevlarWoof:carryDog")

AddEventHandler("DevlarWoof:carryDog", function()
    if spawnedDog ~= nil then
        if inVehicle then
            local vehicle = GetEntityAttachedTo(spawnedDog)
            local vehPos = GetEntityCoords(vehicle)
...
RegisterNetEvent("DevlarWoof:teleportDog")

AddEventHandler("DevlarWoof:teleportDog", function()
    if spawnedDog ~= nil then
        if inVehicle then
            local vehicle = GetEntityAttachedTo(spawnedDog)
            local vehPos = GetEntityCoords(vehicle)
...
RegisterNetEvent("DevlarWoof:spawnDog")

AddEventHandler("DevlarWoof:spawnDog", function(model)
    if spawnedDog == nil then
